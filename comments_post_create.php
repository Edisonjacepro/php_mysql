...
if (
    ...
    !isset($postData['entity_id']) ||
    !is_numeric($postData['entity_id']) ||
...
$entityId = (int)$postData['entity_id'];
...
$insertEntity = $mysqlClient->prepare('INSERT INTO comments(comment, entity_id, user_id, review) VALUES (:comment, :entity_id, :user_id, :review)');
...
<head>
    ...
    <title>Nom du site - Création de commentaire</title>
    <link
